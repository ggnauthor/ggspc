...
;*********** YOUR CODE HERE **************
  ...
  lui  v0, _retsub01 >> 0x10
  addi v0, _retsub01 & 0xffff
  lui  v1, _retsub02 >> 0x10
  addi v1, _retsub02 & 0xffff

  j _label01
  nop

_sub01:
  addi t0, zero, 1  ;実行されない
  jr ra
  nop

_label01:
  bltzall s0, _sub01  ;ジャンプしない
  daddu a0, zero, ra
_retsub01:
  bltzall s1, _sub02  ;ジャンプする
  daddu a1, zero, ra
_retsub02:
  j _label02
  nop
