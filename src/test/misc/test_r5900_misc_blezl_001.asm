...
label1:
  addi t0, zero, 1
label2:
  blezl s1, label3    ;ジャンプする
  addi a1, zero, 1    ;実行される
  j label4
  nop
label3:
  addi t1, zero, 1
label4:
  blezl s2, label5    ;ジャンプする
  addi a2, zero, 1    ;実行される
  j label6
  nop
label5:
  addi t2, zero, 1
label6:
  blezl s3, label7    ;ジャンプしない
  addi a3, zero, 1    ;実行されない
  j label8
  nop
label7:
  addi t3, zero, 1
