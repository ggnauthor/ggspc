...
;*********** YOUR CODE HERE **************
  ...
  ; ノーマル(符号拡張)
  lw a0,  4(v0)  ; 符号なしオフセット
  lw a1, -4(v0)  ; 符号付きオフセット
  lw a2,  0(v0)  ; オフセットなし
  
  ; アドレス変換(符号拡張)
  lw s0,  4(v1)  ; 符号なしオフセット
  lw s1, -4(v1)  ; 符号付きオフセット
  lw s2,  0(v1)  ; オフセットなし
  
  ; ノーマル(ゼロ拡張)
  lwu t0,  4(v0)  ; 符号なしオフセット
  lwu t1, -4(v0)  ; 符号付きオフセット
  lwu t2,  0(v0)  ; オフセットなし
  
  ; アドレス変換(ゼロ拡張)
  lwu t3,  4(v1)  ; 符号なしオフセット
  lwu t4, -4(v1)  ; 符号付きオフセット
  lwu t5,  0(v1)  ; オフセットなし
