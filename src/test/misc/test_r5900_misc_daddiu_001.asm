...
;*********** YOUR CODE HERE **************
  ...
  daddiu t0, s0, 0x4321  ; 繰り上がり無し
  daddiu t1, s1, 2    ; - > +
  daddiu t2, s2, 1    ; +側オーバーフローしない
  daddiu t3, s3, -1    ; -側オーバーフローしない
  daddiu t4, s4, -16    ; 繰り下がり
  daddiu t5, s5, 16    ; 繰り上がり
  
  daddiu s5, s5, 16    ; srcとdstが同じケース
