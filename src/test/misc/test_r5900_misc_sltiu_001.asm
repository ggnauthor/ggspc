...
;*********** YOUR CODE HERE **************
  ...
  sltiu t0, s0, -1  ; s0 == 00000000 00000000
  sltiu t1, s0,  0
  sltiu t2, s0,  1
  
  sltiu t3, s1,  0  ; s1 == 80000000 00000000
  sltiu t4, s1,  1
  sltiu t5, s1, -1
  
  sltiu t6, s2,  0  ; s2 == ffffffff ffffffff
  sltiu t7, s2, -1
  sltiu t8, s2, -2
  
  sltiu a0, s3,  0  ; s3 == 7fffffff ffffffff
  sltiu a1, s3, -1
  sltiu a2, s3, 30000
  
  sltiu v0, s4,  1  ; s4 == 00000000 80000000
  sltiu v1, s5, -1  ; s5 == ffffffff 7fffffff
  
  sltiu s2, s2, -1  ; src‚Ædst‚ª“¯‚¶ƒP[ƒX
